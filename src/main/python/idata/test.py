...
for index in range(len(lin) - 1):
    ...
    # print(add_data)
    # data = [
    #         ('person_id_new', person_id_new),
    #         ('procedure_name', procedure_name)
            # ('procedure_code', procedure_code),
            # ('procedure_date', procedure_date),
            # ('procedure_grade', procedure_grade),
            # ('anesthesia_method', anesthesia_method),
            # ('incision_healing', incision_healing),
            # ('procedure_code_hf', procedure_code_hf),
            # ('class', CLASS)
            # ]
    # print(data)
    # cursor.executemany(add_data, data)

    # (ID,person_id_new,procedure_name,procedure_code,procedure_date,
    # procedure_grade,anesthesia_method,incision_healing,procedure_code_hf,CLASS)
    # 提交更改
    cnx.commit()
